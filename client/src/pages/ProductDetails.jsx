...
export default function ProductDetail() {
  ...
  const { name, price, salePrice, images, description, sizes = [], colors = [], details = [] } = product;
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 sm:py-12">
        ...
        <div className="grid gap-8 lg:grid-cols-2 lg:gap-12">
          ...
          <div>
            ...
            <h1 className="mb-3 text-3xl font-bold tracking-tight sm:text-4xl">{name}</h1>

            <div className="mb-6 flex items-baseline gap-3">
              {isOnSale && (
                <span className="text-xl text-zinc-500 line-through">₵{price}</span>
              )}
      ...
      {showSizeGuide && (
        ...
        >
          ...
          >
            ...
            <button
              onClick={() => setShowSizeGuide(false)}
              className="mt-6 w-full rounded-full bg-black py-3 text-white dark:bg-white dark:text-black"
            >
              Close
            </button>
          </div>
