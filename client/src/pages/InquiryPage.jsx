    ...
    <div className="min-h-screen bg-white text-zinc-900 dark:bg-black dark:text-white">
      <div className="mx-auto max-w-6xl px-4 py-16 sm:py-24">
        ...
        <div className="mb-16 text-center">
          ...
          <h1 className="text-5xl font-bold tracking-tight md:text-6xl">Get in Touch</h1>
          ...
          <div className="space-y-8">
              ...
              <div className="space-y-4 text-zinc-600 dark:text-zinc-400">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a href="mailto:support@emmastudio.com" className="hover:text-rose-500">
                      support@emmastudio.com
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a href="tel:+233555123456" className="hover:text-rose-500">
                      +233 55 512 3456
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-zinc-900 dark:text-white">Studio</p>
            ...
            <div className="rounded-2xl bg-zinc-50 p-6 dark:bg-zinc-950">
              ...
              <p className="text-sm text-zinc-600 dark:text-zinc-400">
                We typically respond within 24 hours on business days. For urgent order issues, include your order number.
              </p>
            </div>
          </div>
          ...
          <div className="lg:col-span-2">
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid gap-6 sm:grid-cols-2">
                <div>
                  ...
                  <input
                    ...
                    className={`w-full rounded-lg border bg-white px-4 py-3 outline-none transition focus:ring-2 focus:ring-rose-500 dark:bg-zinc-900 ${
                      errors.name
                     ? 'border-red-500'
              ...
              <div className="grid gap-6 sm:grid-cols-2">
                <div>
                  <label className="mb-2 block text-sm font-semibold">
                    Order Number <span className="text-zinc-400">(optional)</span>
                  </label>
                  <input
                    type="text"
                    name="orderNumber"
                    ...
                    onChange={handleChange}
                    className="w-full rounded-lg border border-zinc-300 bg-white px-4 py-3 outline-none transition focus:ring-2 focus:ring-rose-500 dark:border-zinc-700 dark:bg-zinc-900"
                    placeholder="#12345"
                  />
                </div>
